...
// I/O Communication
ViStatus tlccs_USB_out(ViSession vi, ViInt16 bRequest, ViUInt16 wValue, ViUInt16 wIndex, ViUInt16 wLength, ViBuf Buffer);
ViStatus tlccs_USB_in(ViSession vi, ViInt16 bRequest, ViUInt16 wValue, ViUInt16 wIndex, ViUInt16 wLength, ViBuf Buffer, ViPUInt16 Read_Bytes);

static ViStatus tlccs_USB_read(ViSession vi, unsigned char *ReceiveData, ViUInt32 Count, ViUInt32 *ReturnCount);
//XXX: undefined static ViStatus tlccs_USB_write(ViSession vi, ViBuf Buffer, ViUInt32 Count, ViUInt32 *ReturnCount);

//XXX: undefined static ViStatus tlccs_query(ViSession vi, ViBuf cmdBuf, ViUInt32 cmdLen, ViBuf rspBuf, ViUInt32 rspLen);
//XXX: undefined static ViStatus tlccs_write(ViSession vi, ViBuf cmdBuf, ViUInt32 cmdLen);
...
//XXX: undefined static ViStatus tlccs_readEEFactoryFlag(ViSession vi, ViPUInt16 flag);
static ViStatus tlccs_writeEEFactoryFlag(ViSession vi, ViUInt16 flag);

//XXX: undefined static ViStatus tlccs_readEEUserFlag(ViSession vi, ViPUInt16 flag);
...
//XXX: undefined static ViStatus tlccs_readEEUserPoly(ViSession vi, ViReal64 poly[]);
...
ViStatus tlccs_setSerialNumber(ViSession vi, ViPChar serial);

ViStatus tlccs_setDarkCurrentOffset(ViSession vi, ViUInt16 evenOffset, ViUInt16 oddOffset);
ViStatus tlccs_getDarkCurrentOffset(ViSession vi, ViPUInt16 even, ViPUInt16 odd);

ViStatus tlccs_writeEEPROM(ViSession vi, ViUInt16 addr, ViUInt16 idx, ViUInt16 len, ViBuf buf, ViUInt16 *chksum);
ViStatus tlccs_writeEEPROM_wo_crc(ViSession vi, ViUInt16 addr, ViUInt16 idx, ViUInt16 len, ViBuf buf);
ViStatus tlccs_readEEPROM(ViSession vi, ViUInt16 addr, ViUInt16 idx, ViUInt16 len, ViBuf buf, ViUInt16* cnt);
ViStatus tlccs_readEEPROM_wo_crc(ViSession vi, ViUInt16 addr, ViUInt16 idx, ViUInt16 len, ViBuf buf, ViUInt16* cnt);
...
---------------------------------------------------------------------------*/
ViStatus tlccs_writeEEPROM(ViSession vi, ViUInt16 addr, ViUInt16 idx, ViUInt16 len, ViBuf buf, ViPUInt16 chksum)
{
   ViStatus err = VI_SUCCESS;
   uint16_t sum = 0;
...
---------------------------------------------------------------------------*/
ViStatus tlccs_readEEPROM(ViSession vi, ViUInt16 addr, ViUInt16 idx, ViUInt16 len, ViBuf buf, ViPUInt16 cnt)
{
   ViStatus err = VI_SUCCESS;
   uint16_t sum = 0;
   uint16_t ees = 0;
...
/*---------------------------------------------------------------------------
   ...
   ViPUInt16 cnt:             The number of Bytes actually read
---------------------------------------------------------------------------*/
ViStatus tlccs_readEEPROM_wo_crc(ViSession vi, ViUInt16 addr, ViUInt16 idx, ViUInt16 len, ViBuf buf, ViPUInt16 cnt)
{
   ViStatus err = VI_SUCCESS;
...
static ViStatus tlccs_checkNodes(ViUInt32 pixel[], ViReal64 wl[], ViInt32 cnt)
{
   ...
   // check pixel range
   if((pixel[cnt - 1] > (TLCCS_NUM_PIXELS - 1))) return VI_ERROR_TLCCS_INV_USER_DATA;
